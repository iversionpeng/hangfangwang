                                                ...
                                                <section id="summary">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="cityId" id="city"
                                                            ...
                                                            <option value="${province.cityCode}">${province.cityName}</option>
                                                            </#list>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="form-control">城镇</label>
                                                        <select name="town" id="townList"
                                                                class="form-control townList">
                                                            <option>--请选择镇区--</option>
                                                        </select>
                                                    </div>
                                                    <div class="row">
...
<script type="text/javascript">
    function cityChange() {
        ...
        var html = "";
        var html1 = "";
        var CommitUrl = "/house/provinceType?code=" + type;
        $.ajax({
            type: "get",
            ...
            success: function (result) {
                var Curedata = $.extend(true, [], result.data);
                if (Curedata != null) {
                    ...
                    $("#townList").empty();
                    $("#townList").append(html);
                    var a = $(".btn-group.bootstrap-select.form-control.townList");
                    var b = a.children(".dropdown-menu.open.animation-fade-out").children();
                    var c = a.children(".btn.dropdown-toggle.selectpicker.btn-default");
                    var d = c.children(".filter-option.pull-left");
                    c.attr("title", Curedata[0]);
                    d.html(Curedata[0]);
                    b.empty();
                    b.append(html1);
                }
